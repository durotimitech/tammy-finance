        ...
        <div className="prose prose-gray max-w-none">
          <section className="mb-8">
            <p className="text-[#2D2D2D] leading-relaxed mb-4">
              Your privacy is important to us. It is tammy policy to respect
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-3 text-[#2D2D2D]">
              <li className="flex items-start">
                ...
                <span>
                  <strong>No Ads:</strong> We will never run advertisements on
                  our platform. Your experience remains clean and focused on
              ...
              <li className="flex items-start">
                ...
                <span>
                  ...
                  personal data or financial information to third parties. Your
                  data is yours alone.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>Account Closure:</strong> You can close your account
          ...
          <section className="mb-8">
            ...
            <p className="text-[#2D2D2D] leading-relaxed mb-4">
              ...
              protect your financial data. All sensitive information is
              encrypted both in transit and at rest. We regularly review and
              update our security measures to ensure your data remains safe.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-[#2D2D2D] leading-relaxed mb-4">
              When you choose to connect third-party services (such as trading
              platforms), we only request the minimum permissions necessary to
              provide our service. Your credentials are encrypted and stored
              securely, and we never share this information with other parties.
            </p>
          </section>
