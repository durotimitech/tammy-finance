    ...
    return (
      ...
      >
        <div className="flex items-center">
          ...
          <p className="text-red-800">Failed to load FIRE calculations. Please try again.</p>
        </div>
      </motion.div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        style={{ borderColor: '#e5e7eb' }}
      >
        <h3 className="text-lg font-semibold mb-4">Tips to Reach FIRE Faster</h3>
        <ul className="space-y-3">
          <li className="flex items-start">
            <span className="text-primary mr-2">•</span>
            <span className="text-gray-700">
              Increase your savings rate - even a 5% increase can shave years off your timeline
            </span>
          </li>
          <li className="flex items-start">
            <span className="text-primary mr-2">•</span>
            <span className="text-gray-700">Reduce monthly expenses to lower your FIRE number</span>
          </li>
          <li className="flex items-start">
            <span className="text-primary mr-2">•</span>
            <span className="text-gray-700">Invest in low-cost index funds for steady growth</span>
          </li>
          <li className="flex items-start">
            <span className="text-primary mr-2">•</span>
            <span className="text-gray-700">
