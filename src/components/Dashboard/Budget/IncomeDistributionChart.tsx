...
export default function IncomeDistributionChart({ incomeSources }: IncomeDistributionChartProps) {
  ...
  const totalValue = incomeEntries.reduce((sum, income) => sum + income.value, 0);
