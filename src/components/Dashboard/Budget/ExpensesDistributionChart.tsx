...
export default function ExpensesDistributionChart({ goals }: ExpensesDistributionChartProps) {
  ...
  const totalValue = expenseEntries.reduce((sum, expense) => sum + expense.value, 0);
