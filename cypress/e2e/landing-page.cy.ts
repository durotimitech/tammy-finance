...
describe("Landing Page", () => {
  ...
  describe("Page Load & Structure", () => {
    ...
    it("should render all main sections in correct order", () => {
      // Hero section
      cy.contains("h1", "Take Control of Your Financial Future").should(
        "be.visible",
      );

      // Features section
      cy.contains("h2", "Powerful Features to Take Control")
        .scrollIntoView()
        .should("be.visible");

      // How it works section
      cy.contains("h2", "Your Path to Financial Freedom")
        .scrollIntoView()
        .should("be.visible");

      // Why different section
      cy.contains("h2", "Why Tammy is Different")
        .scrollIntoView()
        .should("be.visible");
      ...
      // Creator section
      cy.contains("Hello, my name is Timmy")
        .scrollIntoView()
        .should("be.visible");
    });
  });
  ...
  describe("Features Section", () => {
    ...
    it("should display all three feature cards", () => {
      ...
      cy.contains("Calculate your path to Financial Independence").should(
        "be.visible",
      );

      // Net Worth Tracking
      cy.contains("h3", "Net Worth Tracking").should("be.visible");
      cy.contains("Monitor your complete financial picture").should(
        "be.visible",
      );
      ...
      cy.contains(
        "Easily track your daily, weekly, and monthly expenses",
      ).should("be.visible");
    });
  ...
  describe("How It Works Section", () => {
    ...
    it("should display three steps in correct order", () => {
      ...
      cy.contains("Add your assets, liabilities, income, and expenses").should(
        "be.visible",
      );
      ...
      cy.contains(
        "Make informed decisions knowing exactly how they impact",
      ).should("be.visible");
    });
  ...
  describe("Why Tammy is Different Section", () => {
    ...
    it("should display other apps comparison", () => {
      ...
      cy.contains("Fragmented tools that don't talk to each other").should(
        "be.visible",
      );
      cy.contains("Complex spreadsheets that break easily").should(
        "be.visible",
      );
    });
    ...
    it("should display Tammy Finance advantages", () => {
      ...
      cy.contains("Privacy-first, no ads, no data selling").should(
        "be.visible",
      );
  ...
  describe("Creator Section", () => {
    ...
    it("should display creator bio text", () => {
      ...
      cy.contains(
        "I built Tammy because I needed a way to track my journey",
      ).should("be.visible");
  ...
  describe("Footer", () => {
    ...
    it("should display footer logo and description", () => {
      ...
      cy.get("footer")
        .contains("Your personal net worth and budget tracker")
        .should("be.visible");
    });
    ...
    it("should display copyright notice", () => {
      ...
      cy.get("footer")
        .contains("© 2025 tammy - All Rights Reserved")
        .should("be.visible");
    });
  });
